...
// Campo para escrever a tarefa
const textArea = document.querySelector('.app__form-textarea');
// Lista com as tarefas
let tarefas = JSON.parse(localStorage.getItem('tarefas')) || [];

const ulTarefas = document.querySelector('.app__section-task-list');
// Botão para cancelar adição de tarefa
const cancelarBt = document.querySelector('.app__form-footer__button--cancel');
// Campo com a tarefa em andamento
const paragrafoDescricaoTarefa = document.querySelector('.app__section-active-task-description');
// Tarefa selecionada
let tarefaSelecionada = null;
// Item de lista da tarefa selecionada
let liTarefaSelecionada = null;
// Botão para remover tarefas concluidas
